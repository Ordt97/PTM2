...
public class WindowController implements Initializable, Observer {
    ...
    public void Connect() {
        ...
        try {
            ...
            WindowController fc = fxmlLoader.getController();
    ...
    public void drawMark() {
        ...
        try {
            ...
            System.out.println("For calculate path you need to load map");
        }
    }
    ...
    public void setViewModel(ViewModel viewModel) {
        ...
        try {
            ...
            mark = new Image(new FileInputStream("resources/location-mark.png"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (location.getPath().contains("Window.fxml")) {
